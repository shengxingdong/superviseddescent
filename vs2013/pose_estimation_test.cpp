...
int main(int argc, char *argv[])
{
	...
	std::ofstream learned_model_file("face_landmark_pos_regressors.bin", std::ios::binary);
	cereal::BinaryOutputArchive output_archive(learned_model_file);
	output_archive(supervised_descent_model);
#else
	std::ifstream learned_model_file("face_landmark_pos_regressors.bin", std::ios::binary);
	cereal::BinaryInputArchive input_archive(learned_model_file);
